...
2. Predation is another factor that affects many species. Prey species may form patchy groups to avoid predation. If resources remain consistent then I would expect high density areas to remain similar from year to year. 
...
C. I believe the paired t-test is more appropriate for this analysis.  **********
